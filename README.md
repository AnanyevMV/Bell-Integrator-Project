...
* Можно запускать как executable jar. В репозитории содержится jar-файл bell-integrator-project-0.0.1-SNAPSHOT.jar.
Можно его скачать и запустить командой `java -jar bell-integrator-project-0.0.1-SNAPSHOT.jar`, при этом убедившись, что установлен JRE
